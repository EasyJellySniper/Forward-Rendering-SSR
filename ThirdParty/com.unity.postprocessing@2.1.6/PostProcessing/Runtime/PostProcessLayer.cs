...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class PostProcessLayer : MonoBehaviour
    {
        ...
        /// gbuffer in forward
        /// </summary>
        public bool forwardGBuffer = false;
        ...
        CommandBuffer m_LegacyCmdBeforeForwardOpaque;
        Camera m_Camera;
        ...
        void InitLegacy()
        {
            ...
            m_LegacyCmdBeforeForwardOpaque = new CommandBuffer { name = "Before Opaque Forward" };
            ...
            m_Camera.AddCommandBuffer(CameraEvent.BeforeForwardOpaque, m_LegacyCmdBeforeForwardOpaque);
        ...
        void OnDisable()
        {
            ...
            if (m_Camera != null)
            {
                ...
                if (m_LegacyCmdBeforeForwardOpaque != null)
                    m_Camera.RemoveCommandBuffer(CameraEvent.BeforeForwardOpaque, m_LegacyCmdBeforeForwardOpaque);
            }
        ...
        void OnPreCull()
        {
            ...
            // disable depth normal texture pass if using forward gbuffer
            if (forwardGBuffer)
            {
        ...
        void BuildCommandBuffers()
        {
            ...
            m_LegacyCmdBeforeForwardOpaque.Clear();
            ...
            bool isScreenSpaceReflectionsActive = ssrSettings.IsEnabledAndSupported(context) || forwardGBuffer;
            ...
            if (opaqueOnlyEffects > 0)
            {
                ...
                if (isScreenSpaceReflectionsActive)
                {
                    if (forwardGBuffer)
                    {
                        ssrRenderer.SetupForwardGBuffer(m_LegacyCmdBeforeForwardOpaque);
                    }
